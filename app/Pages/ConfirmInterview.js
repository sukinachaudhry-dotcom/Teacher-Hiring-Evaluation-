...
export default function ConfirmInterview({navigation}) {
  return (
    <ScrollView style={{ flex: 1, backgroundColor: "#fff", padding: 10 }}>
      ...
      <View style={{ backgroundColor: "#d8b4e2", padding: 15, borderRadius: 10, marginBottom: 15 }}>
        <Text style={{ fontWeight: "bold", fontSize: 16 }}>You have confirmed your interview attendance</Text>
        ...
        <TouchableOpacity onPress={() => navigation.navigate("Home1")} style={{ backgroundColor: "purple", padding: 10, borderRadius: 20, marginTop: 10 }}>
