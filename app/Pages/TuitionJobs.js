     ...
     {/* Header */}
      ...
      <View style={{ marginVertical: 10, paddingHorizontal: 10 }}>
        ...
        <View style={{ backgroundColor: "#d8b4e2", padding: 15, borderRadius: 10, marginBottom: 15 }}>
          <Text style={{ fontWeight: "bold", fontSize: 16 }}>Math Tutor</Text>
          <Text>Student in Karachi</Text>
          ...
          <View style={{ flexDirection: "row", alignItems: "center", marginTop: 5 }}>
            ...
            <Text>Rs. 2,000 per session</Text>
          </View>
          <View style={{ flexDirection: "row", alignItems: "center", marginTop: 5 }}>
        ...
        {/* Home Tuition Job 2 */}
        <View style={{ backgroundColor: "#d8b4e2", padding: 15, borderRadius: 10, marginBottom: 15 }}>
          <Text style={{ fontWeight: "bold", fontSize: 16 }}>English Tutor</Text>
          <Text>Student in Lahore</Text>
          <View style={{ flexDirection: "row", alignItems: "center", marginTop: 5 }}>
            <Ionicons name="time-outline" size={18} color="black" style={{ marginRight: 6 }} />
            <Text>3 hrs ago</Text>
          </View>
          ...
          <View style={{ flexDirection: "row", alignItems: "center", marginTop: 5 }}>
            <Ionicons name="cash-outline" size={18} color="black" style={{ marginRight: 6 }} />
            <Text>Rs. 2,500 per session</Text>
          </View>
          <View style={{ flexDirection: "row", alignItems: "center", marginTop: 5 }}>
            <MaterialCommunityIcons name="briefcase-outline" size={18} color="black" style={{ marginRight: 6 }} />
        ...
        {/* Home Tuition Job 3 */}
        <View style={{ backgroundColor: "#d8b4e2", padding: 15, borderRadius: 10, marginBottom: 15 }}>
          <Text style={{ fontWeight: "bold", fontSize: 16 }}>Physics Tutor</Text>
          <Text>Student in Islamabad</Text>
          <View style={{ flexDirection: "row", alignItems: "center", marginTop: 5 }}>
            <Ionicons name="time-outline" size={18} color="black" style={{ marginRight: 6 }} />
            <Text>2 hrs ago</Text>
          </View>
        ...
        {/* Home Tuition Job 4 */}
        <View style={{ backgroundColor: "#d8b4e2", padding: 15, borderRadius: 10, marginBottom: 15 }}>
          <Text style={{ fontWeight: "bold", fontSize: 16 }}>Chemistry Tutor</Text>
          <Text>Student in Multan</Text>
          <View style={{ flexDirection: "row", alignItems: "center", marginTop: 5 }}>
            <Ionicons name="time-outline" size={18} color="black" style={{ marginRight: 6 }} />
            <Text>5 hrs ago</Text>
          </View>
